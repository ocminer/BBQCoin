...
{
    BOOST_CHECK(TestSplitHost("www.bbqcoin.org", "www.bbqcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bbqcoin.org]", "www.bbqcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.bbqcoin.org:80", "www.bbqcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bbqcoin.org]:80", "www.bbqcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19323", "127.0.0.1", 19323));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19323", "127.0.0.1", 19323));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19323", "::ffff:127.0.0.1", 19323));
    BOOST_CHECK(TestSplitHost("[::]:19323", "::", 19323));
    BOOST_CHECK(TestSplitHost("::19323", "::19323", -1));
    BOOST_CHECK(TestSplitHost(":19323", "", 19323));
    BOOST_CHECK(TestSplitHost("[]:19323", "", 19323));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19323", "127.0.0.1:19323"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19323", "[::]:19323"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
