...
#ifndef H_BBQCOIN_SCRIPT
#define H_BBQCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBBQCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, BBQCoin always counted CHECKMULTISIGs
