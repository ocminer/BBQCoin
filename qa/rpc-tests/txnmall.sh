...
echo "Done, bbqcoind's shut down. To rerun/poke around:"
echo "${1}/bbqcoind -datadir=$D1 -daemon"
echo "${1}/bbqcoind -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall bbqcoind; rm -rf test.*"
exit 0
