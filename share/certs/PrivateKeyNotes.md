...
unlocked to sign the BBQCoin-Qt.app bundle.
...
allowing somebody to distribute a BBQCoin-Qt.app or bbqcoin-qt-setup.exe with a valid
...
that the bbqcoin-qt.exe file inside the installer had not been tampered with.
